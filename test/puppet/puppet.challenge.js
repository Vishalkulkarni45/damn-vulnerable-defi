...
describe('[Challenge] Puppet', function () {
    ...
    before(async function () {
        ...
        const puppetattack= await ethers.getContractFactory('puppetattack',deployer);

        this.pool= await puppetattack.deploy(this.token.address,this.uniswapFactory.address,this.uniswapFactory);
