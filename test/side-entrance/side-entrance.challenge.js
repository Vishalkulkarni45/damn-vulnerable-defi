...
describe('[Challenge] Side entrance', function () {
    ...
    before(async function () {
        ...
        const sideattacker= await ethers.getContractFactory('FlashLoanEtherReceiver',deployer);
        this.sattack=await sideattacker.deploy(this.pool.address);
    ...
    it('Exploit', async function () {
        this.sattack.attack(this.pool.address);
    });
