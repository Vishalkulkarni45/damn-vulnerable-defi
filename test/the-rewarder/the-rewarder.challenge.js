...
describe('[Challenge] The rewarder', function () {
    ...
    before(async function () {
        ...
        const rewarderattack = await ethers.getContractFactory('rewarderattack',deployer);
        ...
        this.rattack= await rewarderattack.deploy(this.flashLoanPool.address,this.liquidityToken.address,this.rewarderPool.address,attacker.address)
    ...
    it('Exploit', async function () {
        const bal =this.liquidityToken.balanceOf(address(this.flashLoanPool.address));
        this.rattack.attack()
    });
