...
//deposit the dvt token into uniswapv2 contract to manupulate the dvt/weth pool
//now to buy all the token from the puppetv2 contract we need to provide 3 times of its value (i.e 30 weth)
//now withdraw all the dvt token from the contract
//due change in the price of the  dvt/weth pool we were able to withdraw all the token
//refer https://www.youtube.com/watch?v=M9s8wWOP9LU&list=PLwHGiYB583YuDoAjKPDfYMKOmuFIGJCnW&index=8