...
//take the loan from the uniswap (15 eth)
//call _buyone function which first check whether the msg.vslue=15 eth
//then it transfers ownership of the nft to attacker befre transfering the eth to the previous nft owner
//so the contract transfers back our 15 eth to attacker and we can buy all the nfts from the contract  